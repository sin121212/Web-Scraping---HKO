...
class StrongMonsoon:
    ...
    def web_scraping(self):
        ...
        def assign_column_name(df):
            ...
            col_name_list = ['Direction', 'StartTime', 
                             'StartDate', 'EndTime', 'EndDate', 'Duration']
        ...
        def output_format(df):
            ...
            df['WarningStrongMonsoon'] = 'Strong Monsoon ' + df['Direction']
            
            col_list = ['Date', 'WarningStrongMonsoon']
